class Address < ApplicationRecord
  ...
  enum type_cd: { "delivery" => 0, "billing" => 1, "residential" => 2}
  ...
  def complete_address
    "#{zip_code} | #{street_address} - #{city} - #{state} - #{country} | Type: #{type_cd.humanize}"
  end

  def invoice_address
    "#{zip_code} - #{street_address} - #{city} - #{state} - #{country}"
  end
